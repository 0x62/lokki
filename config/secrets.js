module.exports = {
  ...
  db: process.env.MONGODB || process.env.MONGO || 'mongodb://localhost:27017/lokki',

  sessionSecret: process.env.SESSION_SECRET || 'z+NkEftt5ZarcOI2s3HqLrGsUYk4j1Z1ztxQdIwYIDQ',
